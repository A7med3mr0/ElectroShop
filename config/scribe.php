...
return [
    ...
    'auth' => [
        // Enable or disable authentication for the documentation
        'enabled' => true,

        // Set authentication as default for all endpoints
        'default' => true,

        // Where the auth token is sent in the request (Header: Bearer)
        'in' => AuthIn::BEARER->value,

        // The name of the auth header
        'name' => 'Authorization',

        // Local token used by Scribe to run response calls
        'use_value' => env('SCRIBE_AUTH_KEY'),

        // Placeholder displayed in example requests
        'placeholder' => 'YOUR_BEARER_TOKEN',

        // Additional information for developers using the API
        'extra_info' => 'Send the token in the Header as: <code>Bearer {your_token}</code>.',
    ],
